...
try
    ...
    if(isequal(assignment_opts,assignment_opts2))
        assign_flag=0;
        disp('Recomputing assignments for this settings');
    else
        disp('Overwriting assignment with same name, but other Assignment settings !!!!!!!!!!');
    end
end
...
if(assign_flag)
    ...
    for ii=1:nimages   % 总共360张图片
        ...
        texton_ind.cellSize = features.cellSize;
        ...
        switch assignment_opts.type                      % select assignment method
            ...
            otherwise
                disp('A non existing assignment method is selected !!!!!');
        end
